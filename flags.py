...
tf.flags.DEFINE_integer('pretrain_epoch', 20, 'Training epoch')
tf.flags.DEFINE_integer('epoch', 200, 'Training epoch')
...
tf.flags.DEFINE_float('decay_step', 1000, 'learning rate decay step')
...
tf.flags.DEFINE_bool('save_pretrain_model', True, 'Whether to save the trained model')
...
tf.flags.DEFINE_bool('open_transfer', True, 'Whether to use pretraining')
