...
if __name__ == '__main__':
    ...
    #build data for PCNN
    for folder_name in ['baseline','CP','CP_TW','filtered']: #'baseline','CP','CP_HP','HP'
        build_cont_dataset('data/ds_hyphen/'+folder_name+'_train_dev.txt','data/ds_hyphen/'+folder_name+'_train_dev.tfrecords')
        build_cont_dataset('data/ds_hyphen/'+folder_name+'_train.txt','data/ds_hyphen/'+folder_name+'/'+folder_name+'_train.tfrecords')
        split_tfrecord_file('data/ds_hyphen/'+folder_name+'/'+folder_name+'_train.tfrecords', 'data/ds_hyphen/'+folder_name, 128)
